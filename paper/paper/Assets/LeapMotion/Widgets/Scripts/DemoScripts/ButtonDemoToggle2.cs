...
public class ButtonDemoToggle2 : ButtonToggleBase
{
  ...
  public Color MidGraphicsOnColor = new Color(1.0f, 0.5f, 1.0f, 0.5f);
  ...
  {
    onGraphics.SetActive(true);//se activan las letras de encendido
    offGraphics.SetActive(false);//se desactivan las letras de apagado
